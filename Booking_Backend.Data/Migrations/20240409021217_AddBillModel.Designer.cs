...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240409021217_AddBillModel")]
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "6378028f-1dbd-4fa6-a8b0-bb099d45c8db",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d4cd5435-3578-47ff-9416-f90888122626",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ac8097cf-a40c-4618-bbcf-216fc22f40e9",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1a001095-5225-45de-9b44-22bc1f62ff2f",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 314, DateTimeKind.Utc).AddTicks(1753));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ac5a88c1-c564-4988-ae8c-4cc9af337a16",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJXAySUTEUJx2isEUgP55yc4mUrsq4HeQFmn8P9lRSvnao0yXrGeVm1iEeg6Ps6Ciw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "577d7a3b-f069-47bd-85f0-7ae9742252fa",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHkxD1zvylbq8jCwNOrHZ2Pa1FXPw0D2cXbNQv1meBei+xM+LqSHhndRkFHZ2civ1Q==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 375, DateTimeKind.Utc).AddTicks(8492));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 329, DateTimeKind.Utc).AddTicks(3070));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 329, DateTimeKind.Utc).AddTicks(3262));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 329, DateTimeKind.Utc).AddTicks(2688));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 333, DateTimeKind.Utc).AddTicks(5944));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 372, DateTimeKind.Utc).AddTicks(4906));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 355, DateTimeKind.Utc).AddTicks(5110));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 2, 12, 16, 371, DateTimeKind.Utc).AddTicks(76));
