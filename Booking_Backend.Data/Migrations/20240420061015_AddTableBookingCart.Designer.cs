...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240420061015_AddTableBookingCart")]
    partial class AddTableBookingCart
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "f430caaf-64b9-47e5-a5cb-e355cb217b33",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "45ffbe83-e7ad-43dc-ad1f-68b9fe076186",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "594b0664-94a2-47fd-a624-69d7d1ef92b3",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d1bb6a30-17b9-4463-8cf6-3e1ea55c3d9d",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 796, DateTimeKind.Utc).AddTicks(1073));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "b3cc6689-4aa0-4826-aa01-bdad2293c8d5",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBG2uDa82HAJp2ceJ7gNo4kv1VK63b+iefy37Yfe6GYLGAjt1LrkpQskD82C9LYDyQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1a3820a1-bd61-4868-b548-a919d7ebe6b3",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEE7uEGhvYE+jwTyndE8bur4dLAfn1aekjXsXtViXeeBikUNP/ngmHP2JR274Xc9oXw==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 852, DateTimeKind.Utc).AddTicks(4880));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 810, DateTimeKind.Utc).AddTicks(9171));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 810, DateTimeKind.Utc).AddTicks(9312));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 810, DateTimeKind.Utc).AddTicks(8873));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 13, 10, 14, 854, DateTimeKind.Local).AddTicks(3158));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 814, DateTimeKind.Utc).AddTicks(377));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 848, DateTimeKind.Utc).AddTicks(9697));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 833, DateTimeKind.Utc).AddTicks(6594));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 20, 6, 10, 14, 847, DateTimeKind.Utc).AddTicks(1212));
