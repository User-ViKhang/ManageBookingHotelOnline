...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240508085129_UpdataFeedback")]
    partial class UpdataFeedback
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "14d6ca25-7b3a-473f-887a-e7b79bdd8c6e",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "c581b2d8-e6b9-470a-a261-41bce9d27c38",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ddc5a65d-7fdd-43a6-b6f8-587ab22b2c91",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2da2d008-8818-4780-a89b-f4d804d3a23a",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 331, DateTimeKind.Utc).AddTicks(2026));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "84933310-95c1-42df-95cd-7a69289773ea",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBxUvaXdHU9L0LOIjpSYFBJc0rFVL64JRx0SwR2gcHgDdKezsztmxGQZjtWTX2NTrw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2db2e6a7-7d16-4c6d-a929-c4b21953def3",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFS09UumCo33uIVBRE9qRe+gvKnYBVuLHRhgMp2NRD8D8TpGjiovvDLeia5/Hmlm5A==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 382, DateTimeKind.Utc).AddTicks(9316));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 341, DateTimeKind.Utc).AddTicks(7173));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 341, DateTimeKind.Utc).AddTicks(7313));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 341, DateTimeKind.Utc).AddTicks(6908));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 15, 51, 28, 385, DateTimeKind.Local).AddTicks(221));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 344, DateTimeKind.Utc).AddTicks(7746));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.FeedbackCustomer", b =>
                {
                    ...
                    b.Property<int>("FacilitiesScore")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Hotel", b =>
                {
                    ...
                    b.Property<int>("CleanlinessScores")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 379, DateTimeKind.Utc).AddTicks(4863));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 364, DateTimeKind.Utc).AddTicks(2538));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 51, 28, 377, DateTimeKind.Utc).AddTicks(9248));
