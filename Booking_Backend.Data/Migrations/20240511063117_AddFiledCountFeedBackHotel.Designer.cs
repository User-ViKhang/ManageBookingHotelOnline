...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240511063117_AddFiledCountFeedBackHotel")]
    partial class AddFiledCountFeedBackHotel
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "478fa20c-589a-4488-9047-8cac27fe79c0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a63e595f-1d66-463d-9d8f-535108052b9f",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a9c5c261-b3a1-4325-a63e-faab2b1910cb",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f31bae63-e01a-4999-bb68-269d4e1b03c0",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 812, DateTimeKind.Utc).AddTicks(4969));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "6491fe4a-d657-4a77-ab5c-33d81f1ad07f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAcQWzN6OdFzCGJihvX22UV+D86ddx2/f3T1cEl2GlzcidrtFM1DOfy39niNvNbryg==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "cbbfb4b9-eb97-4820-b768-66122e455b8b",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOGRXeCcOL2WGBhPzUmqB7a27gYp/+wf8jtljxkusHOCr4Jjif7sm1EGdVg/mCUaNg==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 865, DateTimeKind.Utc).AddTicks(523));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 823, DateTimeKind.Utc).AddTicks(2935));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 823, DateTimeKind.Utc).AddTicks(3065));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 823, DateTimeKind.Utc).AddTicks(2619));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 13, 31, 16, 866, DateTimeKind.Local).AddTicks(8512));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 826, DateTimeKind.Utc).AddTicks(3033));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 861, DateTimeKind.Utc).AddTicks(1501));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 846, DateTimeKind.Utc).AddTicks(6326));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 11, 6, 31, 16, 859, DateTimeKind.Utc).AddTicks(6387));
