...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240409051543_AddConstraint")]
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "57a590ba-ee1e-4e53-a9de-bbbdc278ca81",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e3bd853e-0975-4a54-b568-deb50da45fb0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "73d360f9-d26e-4a43-9e0c-9cf256884082",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "179b1ccd-7c44-4043-9773-d52eb2cd7e57",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 588, DateTimeKind.Utc).AddTicks(980));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "042e1654-cc0c-4f2c-9a46-3a317cf20833",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECsfMmGO7kgv5v7m22R5xASS0qw8fH4d4X5QAJl22V9R6+DWSshw8DAShh1GmDu05w==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4f0d8de8-8206-48f4-a525-c72c5929515c",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDqrCemFEqacAuijxcoLLCGgEXLJtUJlF8ndZ1EnqtCpls8HgN6E1Eb1lkWsLuuWbg==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 661, DateTimeKind.Utc).AddTicks(3559));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 603, DateTimeKind.Utc).AddTicks(4541));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 603, DateTimeKind.Utc).AddTicks(4678));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 603, DateTimeKind.Utc).AddTicks(4277));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 606, DateTimeKind.Utc).AddTicks(7888));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 657, DateTimeKind.Utc).AddTicks(7019));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 639, DateTimeKind.Utc).AddTicks(7848));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 9, 5, 15, 42, 655, DateTimeKind.Utc).AddTicks(9468));
