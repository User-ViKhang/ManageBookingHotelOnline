...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240331145056_AddFieldTotalRoominBooking")]
    partial class AddFieldTotalRoominBooking
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "94a30262-07c1-4e1f-93a7-4baee50776aa",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "eeb1c95b-2afe-4f74-a8c7-f408e9415f17",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "bc0b2bce-8817-4362-8825-f8e21c384067",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "314f4a9b-d5a3-4a2e-8320-97bf27eeaf31",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 790, DateTimeKind.Utc).AddTicks(4773));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "8e08c308-b68e-450e-b49e-4bf85a526c6f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGH1qdbWJ+N5dv3w+n83fCePIAGJ3I00dTWBEOsORkhD9qgzkzTFaZYjswGe7yUgpg==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2a4608fa-08bb-4d40-baae-9249a291a10e",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMA+BJmEFGAYZ6vrPs+97+5Q/YDT16NOmyofAOl0PsEm0CcUghzSIWYSO7zfHKRjTw==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 806, DateTimeKind.Utc).AddTicks(421));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 806, DateTimeKind.Utc).AddTicks(554));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 806, DateTimeKind.Utc).AddTicks(130));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 808, DateTimeKind.Utc).AddTicks(6537));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 846, DateTimeKind.Utc).AddTicks(6551));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 829, DateTimeKind.Utc).AddTicks(9891));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 50, 55, 844, DateTimeKind.Utc).AddTicks(6049));
