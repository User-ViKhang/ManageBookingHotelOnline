...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240509155527_UpdateHorel")]
    partial class UpdateHorel
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "14b65a0e-94b6-4214-96b8-34046fd8802a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "3f32baa3-3144-48cc-860c-c0c37ea3f694",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ea820c7d-f73f-4efe-a5da-644b2f796d4e",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7f880eb1-7730-484b-9d01-cb26c4bec09f",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 718, DateTimeKind.Utc).AddTicks(8474));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "bbbefcef-e105-4c9d-9975-f4b5fe969fc1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAg01ou8sldtxxdx1gfgcy1iwucuxSGUnhKsaMyx7rF/FH42KDZY2xIzoZColJxPsQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1bcd1f3a-74c5-44b4-9e43-13eb0a8396ff",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGVSz525v6tEJSYvf7iMV++gnD0LZsYDsiUB2P5XFXqZ3OAMQqwm33ZnZyvsotxHfA==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 769, DateTimeKind.Utc).AddTicks(6898));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 729, DateTimeKind.Utc).AddTicks(2068));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 729, DateTimeKind.Utc).AddTicks(2205));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 729, DateTimeKind.Utc).AddTicks(1805));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 22, 55, 26, 771, DateTimeKind.Local).AddTicks(4494));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 732, DateTimeKind.Utc).AddTicks(2056));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 766, DateTimeKind.Utc).AddTicks(1863));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 752, DateTimeKind.Utc).AddTicks(1807));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 9, 15, 55, 26, 764, DateTimeKind.Utc).AddTicks(7172));
