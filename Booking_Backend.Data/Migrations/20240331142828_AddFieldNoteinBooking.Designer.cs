...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240331142828_AddFieldNoteinBooking")]
    partial class AddFieldNoteinBooking
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "5f2661df-e7b9-4cd3-b492-d2b0f0104ffc",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "e5060090-4c67-41fc-8cbb-002e2452b2e5",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "be31da09-0760-427c-8b53-765802fa0e16",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4b1c424b-5f62-4dea-85e6-0a3e0d11ebca",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 79, DateTimeKind.Utc).AddTicks(7595));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "803edc39-94ff-4098-b3dc-b95c9fb599c3",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGnM5SpCJBY9sDTUn/nP1gSRGD/uyg3Bsr1IYr+Ix5BYdk7qgUzFEr7g8p6y6tYbzA==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9382155e-2c29-49bb-a2b1-29320e3db257",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJcvdJog/xc840asD1AvtD/t+59/yRvnegEjNg/uez0j18LOnPo4XZQEP/cwDuCUgQ==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 94, DateTimeKind.Utc).AddTicks(8748));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 94, DateTimeKind.Utc).AddTicks(8883));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 94, DateTimeKind.Utc).AddTicks(8478));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 97, DateTimeKind.Utc).AddTicks(2215));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 132, DateTimeKind.Utc).AddTicks(9264));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 116, DateTimeKind.Utc).AddTicks(8282));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 14, 28, 27, 131, DateTimeKind.Utc).AddTicks(2883));
