...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240331093041_AddGuestCustomerTable")]
    partial class AddGuestCustomerTable
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0b5589b6-2508-4433-965d-633e6bf8651a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4bda9566-db62-4cd2-8e1d-0dadc7b62b5b",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "763c7134-476e-44a8-8008-8dfcdece925b",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "47e3d9af-ed74-4aa4-9208-0aaec35cc44c",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 488, DateTimeKind.Utc).AddTicks(8480));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "53d9618e-fa9c-460f-8de6-e4eeecf5484b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELxeeSd84MfzUPyD9ZMqf4xmSIe8PQgBphqerplAVxmGjqmTEzIa8u2wRO6kEdEpsQ==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "94d98b3f-d0d6-4e14-a17b-042a01ffe4d3",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEH9Q3q8BLJDGRcK8e/7pqDUMu22tLOQnDJMCYxUPbKpwJpDQhVQMH6yy0YdkpgCYaQ==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 509, DateTimeKind.Utc).AddTicks(3324));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 509, DateTimeKind.Utc).AddTicks(3460));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 509, DateTimeKind.Utc).AddTicks(3031));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 512, DateTimeKind.Utc).AddTicks(6020));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 559, DateTimeKind.Utc).AddTicks(4157));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 539, DateTimeKind.Utc).AddTicks(1713));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 31, 9, 30, 40, 557, DateTimeKind.Utc).AddTicks(1938));
