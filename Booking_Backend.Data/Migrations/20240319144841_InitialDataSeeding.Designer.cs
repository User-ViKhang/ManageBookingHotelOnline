...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240319144841_InitialDataSeeding")]
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2ebaf1a1-4f0a-408e-b92e-00ea5a93a978",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "343ea084-f979-4591-be52-f44f26c0ac23",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7e3fe8fe-ec15-4441-9ef5-a21342b84707",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "721771c3-bab4-4fbd-8363-a2d9e244d8d9",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 815, DateTimeKind.Utc).AddTicks(6387));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ee1af177-b2f5-495f-9a23-b2fe45ddac83",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEO3ejeLUC7fGSmj3EzghlFze986NbsxeFRkr34FH/Mg56cHXu4Fe2NOJKO157NIifA==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8db370d8-7bf0-48a0-87d0-f1ff090ea55d",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGCn64z7vH3q0s7ApFad7/1iGltDCLkcgk7ff3DKJ6yos0dgvJTy1j7npK+GPXeP8w==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 831, DateTimeKind.Utc).AddTicks(9295));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 831, DateTimeKind.Utc).AddTicks(9496));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 831, DateTimeKind.Utc).AddTicks(8501));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 835, DateTimeKind.Utc).AddTicks(3266));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelType", b =>
                {
                    ...
                    b.HasIndex("HotelTypeImage_Id")
                        .IsUnique()
                        .HasFilter("[HotelTypeImage_Id] IS NOT NULL");
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 878, DateTimeKind.Utc).AddTicks(5105));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 860, DateTimeKind.Utc).AddTicks(1786));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 19, 14, 48, 40, 876, DateTimeKind.Utc).AddTicks(8682));
