...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240505163001_AddTablefeedbackCustomer")]
    partial class AddTablefeedbackCustomer
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "dcc8562b-e2de-45ea-ab1c-bb3330685831",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "dff7d88a-05df-4778-bbd7-9c5f17355717",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d91797a7-08cf-4180-ae99-adee0dcd1f51",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "0b7f8414-4d9e-4a04-9050-c3cba4ca061e",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 205, DateTimeKind.Utc).AddTicks(2300));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "333ada93-51d0-4107-a2b0-8c352a98057e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKIcCjdG80eMkAKNzArEmujIV20psHzzO+jap/5IzK7QSZEuwOhSLSfrPKBEP6bQtg==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "950a1a9d-2b3e-4deb-9f77-442459f7b074",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOlCL/kvQregzL1924t5U4Yecpep7jbJmBetlKJJv4t6cha4033UVLOFyIh4cpx3VQ==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 262, DateTimeKind.Utc).AddTicks(7763));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 217, DateTimeKind.Utc).AddTicks(2676));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 217, DateTimeKind.Utc).AddTicks(2801));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 217, DateTimeKind.Utc).AddTicks(2419));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 23, 30, 0, 266, DateTimeKind.Local).AddTicks(4451));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 220, DateTimeKind.Utc).AddTicks(2394));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 258, DateTimeKind.Utc).AddTicks(4606));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 239, DateTimeKind.Utc).AddTicks(5075));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 30, 0, 256, DateTimeKind.Utc).AddTicks(3218));
