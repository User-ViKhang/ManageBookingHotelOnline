...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240422143648_UpdateHotelPriceDefault")]
    partial class UpdateHotelPriceDefault
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "c9b2572f-d8c4-47e9-abbb-9e36793346e6",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "90509a2f-1549-4732-a344-d513453dd5be",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f8336941-f150-470f-947e-e815932c5737",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7d9ed6b1-0363-433f-9709-080573e5ad21",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 208, DateTimeKind.Utc).AddTicks(5657));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "36495644-ff49-470a-a96f-84ab340d75f0",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKdRdlsLDOSXJMJZJdJLs4X7BfNbj/9lOWMr1ySY9AsDHwL1waGs1oCKYFOeElEUCg==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ce8a662b-353a-4564-9956-7845ab88ec1e",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDc1ayX15QTthOhbJzL56xXGZ2VsiqYtvinEmJyNtZEBctYxIwcF4vUE5EWnacWwow==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 265, DateTimeKind.Utc).AddTicks(3506));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 224, DateTimeKind.Utc).AddTicks(753));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 224, DateTimeKind.Utc).AddTicks(886));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 224, DateTimeKind.Utc).AddTicks(473));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 21, 36, 47, 267, DateTimeKind.Local).AddTicks(484));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 226, DateTimeKind.Utc).AddTicks(9160));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 261, DateTimeKind.Utc).AddTicks(8353));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 247, DateTimeKind.Utc).AddTicks(6040));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 14, 36, 47, 260, DateTimeKind.Utc).AddTicks(2907));
