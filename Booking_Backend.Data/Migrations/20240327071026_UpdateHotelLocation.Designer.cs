...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240327071026_UpdateHotelLocation")]
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "25e2fba4-7519-4360-9af5-ec7655946a21",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "80002b79-b1d0-40dd-a95d-a13162e6d5b9",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "86d8ace0-738d-468f-bb19-17d0509ae2e8",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "28fb370c-574f-4ec6-a9be-d1d2716994e6",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 870, DateTimeKind.Utc).AddTicks(6666));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "86ad4a3b-3e28-445f-996c-00e58ef1babd",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBNYSdH3L+nMn+sy+x+CZTVXr6Qm7o2Us19/tHcyRHTQ4CrhTl3HjfevrNy2VypaKw==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "0de2488f-bc60-461b-bcec-1afc8c09b99e",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEIxO62ez39H/HNDY8Z0XK+aW+ohurfSCEWrPvYPLuymGEVA5VSmZ1GvN3DU42LA4g==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 885, DateTimeKind.Utc).AddTicks(4331));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 885, DateTimeKind.Utc).AddTicks(4468));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 885, DateTimeKind.Utc).AddTicks(4071));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 887, DateTimeKind.Utc).AddTicks(4509));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 920, DateTimeKind.Utc).AddTicks(7139));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 905, DateTimeKind.Utc).AddTicks(7727));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 3, 27, 7, 10, 25, 919, DateTimeKind.Utc).AddTicks(2400));
