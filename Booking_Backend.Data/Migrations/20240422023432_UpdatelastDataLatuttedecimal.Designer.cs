...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240422023432_UpdatelastDataLatuttedecimal")]
    partial class UpdatelastDataLatuttedecimal
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "e28d7f9d-c25c-4b0b-b04d-9f2bf619d4d0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "202c8206-c7fe-439d-b04b-a017f860a69b",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2a91fc50-8922-4588-afde-922b447105d0",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7b636698-65b2-4ec9-8a1b-c047f8d0292a",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 267, DateTimeKind.Utc).AddTicks(2090));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a9110126-445c-4fad-85c3-f63b9849a890",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEExeLIpKf+rVDg13ehkwztlqRrmMhr61oj2EVtQS8oP0W7S0/2PGKK9kuAN8M1YI5A==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5d29edc3-041d-43e8-89b4-37c26c78d21e",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAEQTN/OugHDDmDDgeGu24p6ZBpYjdkBhxkl7Chej36vvmH3rUf5KtAgREQPvLhOaQ==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 322, DateTimeKind.Utc).AddTicks(4128));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 282, DateTimeKind.Utc).AddTicks(780));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 282, DateTimeKind.Utc).AddTicks(919));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 282, DateTimeKind.Utc).AddTicks(504));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 9, 34, 31, 324, DateTimeKind.Local).AddTicks(2066));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 284, DateTimeKind.Utc).AddTicks(9109));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 319, DateTimeKind.Utc).AddTicks(314));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 304, DateTimeKind.Utc).AddTicks(2236));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 22, 2, 34, 31, 317, DateTimeKind.Utc).AddTicks(4737));
