...
namespace Booking_Backend.Data.Migrations
{
    ...
    [Migration("20240508084741_UpdataFeedbacCustomer")]
    partial class UpdataFeedbacCustomer
    {
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "efe4f406-4e0a-44f3-92fa-90a4e0701e7e",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "07498440-a657-482d-b965-0f379dc93626",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "a9a29792-ccb9-4960-a4f7-06d545d44a92",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9381eb16-e14b-4790-8704-2fbd996e7f42",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 15, DateTimeKind.Utc).AddTicks(8407));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2d6ce466-bb54-4be5-8356-b3305faaa86f",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMrIRCbLcyxazF/r2Mkk3O0BvW7fygNiWa4dPF1sbL8RE/XBRGCCktUz8eD1ki0e1w==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "316c7993-0ac1-460c-98cf-d1e6292bcf4a",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Dashboard = 354261197,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAfmAtviH0AvjgINmqc8anIlZbno89KY61aB9ycVaeYnyh0BAVDZxf6OZfxwdIxI3g==",
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("Created_at")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 87, DateTimeKind.Utc).AddTicks(5669));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CheckIn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 28, DateTimeKind.Utc).AddTicks(7633));

                    b.Property<DateTime>("CheckOut")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 28, DateTimeKind.Utc).AddTicks(7793));

                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 28, DateTimeKind.Utc).AddTicks(7353));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.BookingCarts", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 15, 47, 40, 90, DateTimeKind.Local).AddTicks(2150));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 32, DateTimeKind.Utc).AddTicks(8368));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.HotelTypeImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 83, DateTimeKind.Utc).AddTicks(2758));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.Image", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 62, DateTimeKind.Utc).AddTicks(1818));
            ...
            modelBuilder.Entity("Booking_Backend.Data.Entities.UserImage", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 8, 8, 47, 40, 81, DateTimeKind.Utc).AddTicks(4201));
